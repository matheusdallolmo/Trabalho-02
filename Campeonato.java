...
public class Campeonato {
    ...
    public void incluirJogador() {
        ...
        if (quantJog != 10) {
            ...
            // Do while para escolher o tipo de jogador correto maiusculo ou minusculo
            do {
        ...
        if (quantJog == 0)
            ...
            for (i = 0; i < 10; i++) {
                ...
                for (int r = 0; r < quantJog; r++) {
                    if (jogadores[r].getSaldo() > 0) { //if para validar se o jogador tem saldo para apostar
                        ...
                        if (jogadores[r] instanceof Humano) {
                            ...
                            do {
                                ...
                                // Atualizar o saldo do
                                // jogador
                            } while (valorAposta > jogadores[r].getSaldo() || valorAposta <= 0);

                            jogadores[r].setSaldo(jogadores[r].getSaldo() - valorAposta);
